...
def main(config_file):
	# 暂时不输出output_foloder
	input_folder, extensions, export_name, current_pattern_index = read_config(config_file)
...
def process_revit_files(input_folder, output_folder, export_name, extensions, pattern_index):
